...
DATAPATH = '/gpfs/data/bkimia/cchien3/CS2470-Deep-Learning-Final-Project/Database-Assisted-Object-Retrieval-3D-Room-Reconstruction/Furniture_Dataset/sofa'
image_path = {}
image_label = {}


class FurnitureSofaDataset(Dataset):
    """
    # Description:
