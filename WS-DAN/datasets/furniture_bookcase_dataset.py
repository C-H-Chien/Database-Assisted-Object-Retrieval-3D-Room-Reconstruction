...
DATAPATH = '/gpfs/data/bkimia/cchien3/CS2470-Deep-Learning-Final-Project/Database-Assisted-Object-Retrieval-3D-Room-Reconstruction/Furniture_Dataset/bookcase'
image_path = {}
image_label = {}


class FurnitureBookcaseDataset(Dataset):
    """
    # Description:
    ...
    def __init__(self, phase='train', resize=300):
