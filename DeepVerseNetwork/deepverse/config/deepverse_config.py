...
from deepverse.config import maskrcnn_config
from deepverse.data.constants import IMAGE_SIZE
from deepverse.modeling import DeepVerse, DeepVerseROIHeads


def deepverse_config(
    train_data: str,
    test_data: str,
    batch_size: int = 2,
    ...
    # Set roi heads
    cfg.MODEL.META_ARCHITECTURE = DeepVerse.__name__
    cfg.MODEL.ROI_HEADS.NAME = DeepVerseROIHeads.__name__
