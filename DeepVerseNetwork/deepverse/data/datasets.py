...
from deepverse.data.cad_manager import register_cads
from deepverse.data.category_manager import register_categories
...
def register_scan2cad(
    ...
    cad_file = os.path.join(data_dir, 'scan2cad_val_cads.pkl')
    ...
    # -- appears in [cad_manager.py] which indirectly calls the CADManager class --
