...
from deepverse.data import CategoryCatalog
from deepverse.data.constants import (
    CAD_TAXONOMY,
    CAD_TAXONOMY_REVERSE,
    IMAGE_SIZE,
)
from deepverse.structures import Rotations
from deepverse.utils.alignment_errors import (
    rotation_diff,
    scale_ratio,
    translation_diff,
)
from deepverse.utils.linalg import decompose_mat4, make_M_from_tqs
...
def eval_csv(
    ...
    # FIXME: relative path!
    eval_path = __file__
    for i in range(4):  # -> eval -> deepverse -> network
